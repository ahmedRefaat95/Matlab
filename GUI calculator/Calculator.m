...
% Last Modified by GUIDE v2.5 31-Jan-2020 19:00:34
...
set(handles.popupmenu1, 'String', operations);
...
switch (operation)
    ...
    case '+'
        result = str2num(num1) + str2num(num2);
    case '-'
        result = str2num(num1) - str2num(num2);
    case '*'
        result = str2num(num1) * str2num(num2);
...
set(handles.text4,'string',num2str(result) );
...
set(handles.text2,'string',operands(op));
